...
export const metadata: Metadata = {
  title: "ロゴ作成AIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "無料で高品質なロゴを生成できるロゴ作成AI7選を徹底比較。商用利用可否・料金・選び方のポイントを解説します。",
  alternates: {
...
export default function AILogoCreationPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIロゴ作成", item: `${siteConfig.url}/guide/ai-logo-creation` },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">ロゴ制作を副業として伸ばしたい方へ</h2>
          <p className="text-sm text-muted mb-4">AI生成と組み合わせるデザイン・Web制作スキルがあれば、ロゴ単体ではなくブランディング案件も狙えます。</p>
          <ComparisonTableCTA
            services={[
