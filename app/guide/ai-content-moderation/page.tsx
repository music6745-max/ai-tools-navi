...
export const metadata: Metadata = {
  title: "コンテンツモデレーションAIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "UGC運営の安全対策に使えるコンテンツモデレーションAI6選を徹底比較。検知精度と料金・選び方を解説します。",
...
export default function AIContentModerationPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIコンテンツモデレーション", item: `${siteConfig.url}/guide/ai-content-moderation` },
    ],
  };
