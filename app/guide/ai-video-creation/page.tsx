...
export const metadata: Metadata = {
  title: "動画生成AIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "テキストから動画を自動生成できるAI7選を徹底比較。Sora・Runway・Pikaなど主要ツールの特徴・料金・選び方を初心者向けに解説します。",
  alternates: {
...
export default function AIVideoCreationPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "動画生成AI", item: `${siteConfig.url}/guide/ai-video-creation` },
    ],
  };
