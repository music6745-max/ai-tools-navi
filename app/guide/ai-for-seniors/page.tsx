...
export const metadata: Metadata = {
  title: "シニア向けAIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "60代70代から始められるシニア向けAI6選を徹底比較。簡単操作・サポート体制で選ぶポイントを解説します。",
...
export default function AIForSeniorsPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "シニア向けAI", item: `${siteConfig.url}/guide/ai-for-seniors` },
    ],
  };
