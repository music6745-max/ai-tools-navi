...
export const metadata: Metadata = {
  title: "SEO対策AIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "検索上位を狙えるSEO対策AI7選を徹底比較。Surfer SEO・Fraseなど主要ツールの料金・機能・選び方を解説します。",
  alternates: {
...
export default function AISEOPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI SEO対策", item: `${siteConfig.url}/guide/ai-seo` },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">Webマーケ・SEOを体系的に学びたい方へ</h2>
          <p className="text-sm text-muted mb-4">AI SEOツールの効果を最大化するには、Web制作・データ分析の基礎理解が大きな武器になります。</p>
          <ComparisonTableCTA
            services={[
