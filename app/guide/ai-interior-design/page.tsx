...
export const metadata: Metadata = {
  title: "インテリアAIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "部屋のコーディネートを自動提案するインテリアデザインAI6選を徹底比較。料金・特徴・選び方を分かりやすく解説します。",
  alternates: {
...
export default function AIInteriorDesignPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIインテリアデザイン", item: `${siteConfig.url}/guide/ai-interior-design` },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">空間デザインを仕事につなげたい方へ</h2>
          <p className="text-sm text-muted mb-4">CADや3D、Web制作スキルを体系的に身につけると、AIで描いたイメージを実案件に展開しやすくなります。</p>
          <ComparisonTableCTA
            services={[
