...
export const metadata: Metadata = {
  title: "英文校正AIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "ビジネス英語を自然に添削できる英文校正AI6選を徹底比較。Grammarly・DeepL Writeなど主要ツールの選び方を解説します。",
  alternates: {
...
export default function AIEnglishProofreadingPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI英文校正", item: `${siteConfig.url}/guide/ai-english-proofreading` },
    ],
  };
