...
export const metadata: Metadata = {
  title: "メール作成AIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "ビジネスメールを自動化できるメール作成AI6選を徹底比較。ChatGPTなど主要ツールの活用術と選び方を解説します。",
  alternates: {
...
export default function AIEmailWritingPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIメール作成", item: `${siteConfig.url}/guide/ai-email-writing` },
    ],
  };
