...
export const metadata: Metadata = {
  title: "字幕作成AIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "動画字幕を自動生成できる字幕作成AI6選を徹底比較。多言語対応・精度・料金で選ぶポイントを分かりやすく解説します。",
  alternates: {
...
export default function AISubtitleCreationPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI字幕作成", item: `${siteConfig.url}/guide/ai-subtitle-creation` },
    ],
  };
