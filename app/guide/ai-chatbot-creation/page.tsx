...
export const metadata: Metadata = {
  title: "チャットボット作成AIおすすめ6選【2026年最新】徹底比較｜選び方も解説",
  description:
    "ノーコードで自社ボットを構築できるチャットボット作成AI6選を徹底比較。導入コストと選び方を解説します。",
  alternates: {
...
export default function AIChatbotCreationPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIチャットボット作成", item: `${siteConfig.url}/guide/ai-chatbot-creation` },
    ],
  };
