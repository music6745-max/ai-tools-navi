...
export default function AIBlogWritingPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIブログ執筆", item: `${siteConfig.url}/guide/ai-blog-writing` },
    ],
  };
    ...
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, item: { "@type": "Thing", name: "Jasper", url: "https://www.jasper.ai/" } },
          { "@type": "ListItem", position: 4, item: { "@type": "Thing", name: "Notion AI", url: "https://www.notion.so/product/ai" } },
        ],
      }) }} />
