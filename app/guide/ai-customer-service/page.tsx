...
export const metadata: Metadata = {
  title: "カスタマーサービスAIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "顧客対応を効率化するカスタマーサービスAI7選を徹底比較。チャットボット・FAQ自動化まで選び方を解説します。",
  alternates: {
...
export default function AICustomerServicePage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AIカスタマーサービス", item: `${siteConfig.url}/guide/ai-customer-service` },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">CS業務の自動化と次のキャリアを考える</h2>
          <p className="text-sm text-muted mb-4">ノーコード活用に加えてプログラミングの基礎を身につけると、社内ツール改善や転職の幅が広がります。</p>
          <ComparisonTableCTA
            services={[
