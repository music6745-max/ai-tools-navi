...
export const metadata: Metadata = {
  title: "リモートワーク向けAIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "リモートワークを効率化するAI7選を徹底比較。会議・コミュニケーション・タスク管理に役立つ選び方を解説します。",
...
export default function AIForRemoteWorkPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "リモートワーク向けAI", item: `${siteConfig.url}/guide/ai-for-remote-work` },
    ],
  };
