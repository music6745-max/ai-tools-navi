...
export const metadata: Metadata = {
  title: "要約AIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "長文記事・論文・PDFを瞬時に要約できるAI7選を徹底比較。ChatGPT・Claudeなど主要ツールの精度と使い方、選び方のポイントを解説します。",
  alternates: {
...
export default function AISummaryPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI要約ツール", item: `${siteConfig.url}/guide/ai-summary` },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-bold mb-4">情報処理スキルを次のステップへ</h2>
          <p className="text-sm text-muted mb-4">AI要約で得た情報を活かすには、業務効率化やデータ活用、プログラミングの基礎も合わせて学ぶのがおすすめです。</p>
          <ComparisonTableCTA
            services={[
