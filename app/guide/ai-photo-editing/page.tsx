...
export const metadata: Metadata = {
  title: "画像編集AIおすすめ7選【2026年最新】徹底比較｜選び方も解説",
  description:
    "写真加工を自動化できる画像編集AI7選を徹底比較。Photoshop・Luminar・Picsartなど主要ツールの選び方を解説します。",
  alternates: {
...
export default function AIPhotoEditingPage() {
  ...
  const breadcrumbLd_seo = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "AI画像編集", item: `${siteConfig.url}/guide/ai-photo-editing` },
    ],
  };
